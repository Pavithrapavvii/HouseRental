...
public class RegisterModuleIntegration {
//  register to home module integration
	public static void main(String[] args) {
		...
		String register = driver.findElement(By.xpath("//b[text()='Registered Users: ']/child::span")).getText();
		System.out.println(register);
		
		driver.findElement(By.xpath("//a[.='Register']")).click();               //  click on register button
		driver.findElement(By.id("fullname")).sendKeys("Mallikarjun");           //  enter to full name textbox
		driver.findElement(By.id("mobile")).sendKeys("6666666663");              //  enter to mobile textbox
		driver.findElement(By.id("email")).sendKeys("malli134@gmail.com");       //  enter to email textbox
		...
		String register1 = driver.findElement(By.xpath("//b[text()='Registered Users: ']/child::span")).getText();
		System.out.println(register1);
		if(register.equals(register1))
