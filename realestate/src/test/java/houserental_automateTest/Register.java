...
public class Register {
	...
	{
		FileInputStream fis=new FileInputStream("projectEnvConfig.properties"); 
		...
		String URL = System.getProperty("url",pobj.getProperty("url"));         // fetching the value of URL
		String USERNAME =System.getProperty("username", pobj.getProperty("username"));   // fetching the value of user
	...
	/*	if(BROWSER.equals("chrome")) {      // comparing the user entered browser and open that browser
	   ...
	   for(int i=0;i<10;i++)
	   {
		...
		driver.findElement(By.id("mobile")).sendKeys(s1);         //  enter to mobile textbox
